...
function navigationLinks() { return `<a class="live-nav-link" href="/direct/"><i></i> En direct</a><a href="/emissions/">Émissions</a><a href="/programmes/hors-norme/">Hors Norme</a><a href="/programmes/concept-libre/">Concept Libre</a><a href="/espace-client/">Espace client</a><a class="btn btn-primary" data-funnel href="${bookingUrl('public_header')}">Voir les créneaux</a>`; }
