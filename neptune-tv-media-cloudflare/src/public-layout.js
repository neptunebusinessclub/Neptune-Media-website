...
export function bookingLink(episode) {
  ...
  url.searchParams.set('utm_source', 'webtv'); url.searchParams.set('utm_medium', 'episode_page'); url.searchParams.set('utm_campaign', 'neptune_media'); url.searchParams.set('episode', episode.slug || episode.id);
  return url.toString();
}
