...
function navigationLinks() {
  return `<a class="live-nav-link" href="/direct/"><i></i> Direct</a><a href="/emissions/">Neptune TV</a><a href="/#formats">Formats</a><a href="/espace-client/">Espace client</a><a class="btn btn-primary" data-funnel href="${bookingUrl('public_header')}">Voir les créneaux</a>`;
}
