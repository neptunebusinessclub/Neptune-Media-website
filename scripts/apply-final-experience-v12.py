...
def retire_conflicting_layers(text: str) -> str:
    text = text.replace('  <link rel="stylesheet" href="/styles/apple-conversion-v13.css?v=13">\n', '')
    text = text.replace('<link rel="stylesheet" href="/styles/apple-conversion-v13.css?v=13">', '')
    text = text.replace(' data-apple-ux="v13"', '')
    return text


def patch_homepage() -> None:
    html = retire_conflicting_layers(INDEX.read_text(encoding="utf-8"))
...
def patch_public_layout() -> None:
    source = retire_conflicting_layers(LAYOUT.read_text(encoding="utf-8"))
...
def patch_router() -> None:
    ...
    if "body.replaceAll('<link rel=\"stylesheet\" href=\"/styles/final-experience-v12.css" not in source:
        ...
        source = source.replace("  if (mode === 'public') {\n    body = body.replaceAll('<link rel=\"stylesheet\" href=\"/styles/final-experience-v12.css?v=1\">', '');", "  if (mode === 'public') {\n    body = body.replaceAll('<link rel=\"stylesheet\" href=\"/styles/apple-conversion-v13.css?v=13\">', '');\n    body = body.replaceAll(' data-apple-ux=\"v13\"', '');\n    body = body.replaceAll('<link rel=\"stylesheet\" href=\"/styles/final-experience-v12.css?v=1\">', '');")
